...
const (
	...
	C2S_GM_CARDCALL = 1053 // GM命令 - 抽卡测试
	...
	C2S_USER_TASK_LINE_UNLOCK        = 1137 // 主线副本花费解锁
	C2S_USER_BOSS_TASK_INFO          = 1138 // 主线boss关卡信息
	C2S_USER_TASK_CHAPTER_BOX_SUBMIT = 1141 // 领取主线宝箱
	...
	C2S_USER_FIRM_PROP_AUTO_STUDY_START  = 1205 // 开始自动学习
	C2S_USER_FIRM_PROP_AUTO_STUDY_FINISH = 1206 // 结束自动学习
	C2S_USER_FIRM_PROP_AUTO_STUDY_SUBMIT = 1207 // 一键领取经验
	...
	C2S_USER_CARD_TALENT_UNLOCK          = 1510 // 解锁天赋树
	C2S_USER_CARD_SKILL_LEARN            = 1511 // 领悟卡牌技能
	C2S_USER_CARD_SKILL_SAVE             = 1512 // 保存卡牌技能
	...
	C2S_USER_HOME_DIAMOND_BUY                = 1723 // 购买小屋钻石
	C2S_USER_HOME_SPEEDUP_ITEM_BUY           = 1724 // 购买小屋加速卡
	C2S_USER_BILLBOARD_DATE_TICKET_BUY       = 1725 // 购买看板一日约会门票
	C2S_USER_BILLBOARD_TIME_LIMIT_TICKET_BUY = 1726 // 购买看板限时一日约会门票
	...
	C2S_USER_RANK_POWER_LIST = 1941 // 获取战力排行榜
	...
	C2S_USER_FH_QUEST_COUNTING = 2100 // bingo 前端任务发送，后端过滤校验
	...
	C2S_USER_SPACE_DESC_UPDATE       = 2781 // 更新空间签名
	C2S_USER_SPACE_SHOW_CARD_UPDATE  = 2782 // 更新空间展示卡牌
	C2S_USER_SPACE_QUERY             = 2783 // 获取空间信息
	...
	C2S_USER_FH_GET_INFO                  = 2850 // 小屋详细信息
	C2S_USER_FH_UNLOCK_AREA               = 2851 // 小屋解锁区域
	C2S_USER_FH_SET_POS                   = 2852 // 小屋保存女主坐标
	C2S_USER_FH_DECORATE                  = 2853 // 小屋装饰
	C2S_USER_FH_AREA_STORY_REWARD_SUBMIT  = 2854 // 小屋区域剧情奖励领取
	C2S_USER_FH_UNLOCK_UNIT               = 2855 // 小屋单元解锁
	C2S_USER_FH_UNIT_PATTERN_RECOVER      = 2856 // 小屋家具回收
	C2S_USER_FH_BRIEF_INFO                = 2857 // 小屋简要信息
	C2S_USER_FH_GIFT_REWARD_SUBMIT        = 2858 // 小屋收菜
	C2S_USER_FH_ACHV_SUBMIT               = 2859 // 小屋成就（主线）提交
	C2S_USER_FH_DAILY_QUEST_SUBMIT        = 2860 // 小屋每日任务提交
	C2S_USER_FH_GIVE_PRESENT              = 2861 // 小屋送礼
	C2S_USER_FH_UNIT_EXPLORE_SUBMIT       = 2862 // 小屋家具交互
	C2S_USER_FH_DAILY_QUEST_BONUS_SUBMIT  = 2863 // 小屋额外奖励领取
	C2S_USER_FH_MALE_INTERA_SUBMIT        = 2864 // 小屋双人交互
	C2S_USER_FH_RELATE_REWARD_SUBMIT      = 2865 // 小屋亲密度奖励领取
	C2S_USER_HOME_RAND_REWARD_UNIT_SUBMIT = 2866 // 小屋家具收菜奖励提交

	C2S_USER_HOME_DISPATCH_INFO_REQ          = 2870 // 获取指定男主派遣信息
	C2S_USER_HOME_DISPATCH_START_REQ         = 2871 // 开始派遣
	C2S_USER_HOME_DISPATCH_SPEEDUP_REQ       = 2872 // 加速派遣
	C2S_USER_HOME_DISPATCH_GETREWARD_REQ     = 2873 // 领奖励
	C2S_USER_HOME_DISPATCH_CANCEL_REQ        = 2874 // 执行撤销操作
	C2S_USER_HOME_DISPATCH_REFRESH_REQ       = 2875 // 刷新请求
	C2S_USER_HOME_DISPATCH_CURRENT_BRIEF_REQ = 2876 // 获取当前派遣队列状态（红点）

	C2S_USER_HOME_BUBBLE_GET_REQ    = 2880 // 获取气泡协议（包含主线剧情 短事件）
	C2S_USER_HOME_BUBBLE_FINISH_REQ = 2881 // 完成气泡协议（包含主线剧情 短事件）

	C2S_USER_HOME_GUIDE_BONUS_SUBMIT = 2890 // 领取小屋新手引导奖励

	C2S_USER_BILLBOARD_MALE_SELECT                 = 2901 // 看板系统 选择看板内出现的男主
	C2S_USER_BILLBOARD_MALE_STATE_SUBMIT           = 2902 // 看板系统 男主状态变更 进入看板系统的时候才发过来
	C2S_USER_BILLBOARD_MALE_RESPONSE_REWARD_SUBMIT = 2903 // 看板系统 男主反馈领取奖励
	C2S_USER_BILLBOARD_PURCHASE_ITEM               = 2904 // 看板系统 在面板购买已解锁物品
	C2S_USER_BILLBOARD_DRESSUP_SUBMIT              = 2905 // 看板系统 男主换装提交
	C2S_USER_BILLBOARD_DATE_LIST_REQ               = 2906 // 看板系统 获取一日约会入口
	C2S_USER_BILLBOARD_DATE_ENTER                  = 2907 // 看板系统 进入一日约会
	C2S_USER_BILLBOARD_DATE_MOVE                   = 2908 // 看板系统 一日约会进行选择
	C2S_USER_BILLBOARD_DATE_FINISH                 = 2909 // 看板系统 一日约会结束领奖
	C2S_USER_ENTER_BILLBOARD                       = 2910 // 进入看板系统
	C2S_USER_BILLBOARD_MUSIC_SUBMIT                = 2911 // 看板系统 更换BGM
	C2S_USER_BILLBOARD_LOGIN_FAVOR                 = 2912 // 看板系统 登录增加好感度

	C2S_USER_MATERIAL_TASK_DO            = 3001 // 开始天赋树材料副本
	C2S_USER_MATERIAL_TASK_LEAVE         = 3002 // 离开天赋树材料副本
	C2S_USER_MATERIAL_TASK_SWEEP         = 3003 // 扫荡天赋树材料副本
	C2S_USER_MATERIAL_TASK_BUY_CNT       = 3004 // 购买天赋树材料副本次数
	C2S_USER_MATERIAL_TASK_REWARD_SUBMIT = 3005 // 领取天赋树材料副本奖励

	C2S_USER_PUBLISH_ZONE_MSG_SUBMIT = 3011 // 发布大区广播消息
	C2S_USER_GET_ZONE_MSG_SUBMIT     = 3012 // 获取大区广播消息
	...
	C2S_USER_SYSTEM_ACTIVE_TIME                  = 4031 // 系统活跃时间通知
	C2S_USER_ACTIVITY_LIVENESS_ADDUP_SUBMIT      = 4032 // 领取累计活跃度奖励
	C2S_USER_ACTIVITY_MAIN_QUEST_GET_AWARD       = 4033 // 主线卡每日宝箱

	C2S_USER_ACTIVITY_NEW_BIRTHDAY_MAKE_PRESENT = 4041 // 新生日礼物制作
	C2S_USER_ACTIVITY_NEW_BIRTHDAY_SEND_PRESENT = 4042 // 新生日送礼
	C2S_USER_ACTIVITY_PUBLISH_REWARD_SUBMIT     = 4043 // 发布奖励领取
	C2S_USER_ACTIVITY_NEW_BIRTHDAY_FILE_SELECT  = 4044 // 新生日选择档案选项
	C2S_USER_ACTIVITY_NEW_BIRTHDAY_STORY_READ   = 4045 // 新生日进入剧情

	C2S_EXCHANGE_GOODS_SUBMIT         = 4051 // 兑换请求
	C2S_EXCHAGNE_STORE_REFRESH_SUBMIT = 4052 // 兑换商店刷新请求

	C2S_SPRING_FESTIVAL_PIECE_GAIN_SUBMIT         = 4061 // 春节翻牌子
	C2S_SPRING_FESTIVAL_PIECE_SHARE_SUBMIT        = 4062 // 春节翻牌子 分享
	C2S_SPRING_FESTIVAL_PIECE_SHARE_REWARD_SUBMIT = 4063 // 春节翻牌子 领取分享奖励
	C2S_SPRING_FESTIVAL_PIECE_OPEN_REWARD_SUBMIT  = 4064 // 春节翻牌子 打开礼物

	C2S_DOUBLE_ACTIVITY_REWARD_SUBMIT            = 4071 // 一元限购 领取奖励
	C2S_DOUBLE_ACTIVITY_CUMULATION_REWARD_SUBMIT = 4072 // 一元限购 累积奖励响应

	C2S_USER_ACTIVITY_HOME_LOTTERY_SUBMIT = 4080 // 家具阁抽奖

	C2S_USER_YSDK_GET_BALANCE_SUBMIT = 4090 // 拉取米大师余额请求

	C2S_USER_ACTIVITY_SNOW_TASK_MERGE_SUBMIT        = 4100 // 新主线预热 合成
	C2S_USER_ACTIVITY_SNOW_TASK_SHARE_SUBMIT        = 4101 // 新主线预热 分享
	C2S_USER_ACTIVITY_SNOW_TASK_WATCH_PV_SUBMIT     = 4102 //新主线预热 观看视频
	C2S_USER_ACTIVITY_SNOW_TASK_SHARE_REWARD_SUBMIT = 4103 //新主线预热 领取分享奖励

	C2S_USER_ACTIVITY_H5_WEBVIEW = 6001 // H5页面参数加密结果
)
...
const (
	...
	S2C_GM_CARDCALL_RET = 1053 // GM命令 - 抽卡测试
	...
	S2C_USER_TASK_LINE_UNLOCK_RET        = 1137 // 主线副本花费解锁
	S2C_USER_BOSS_TASK_INFO_RET          = 1138 // 主线boss信息
	S2C_USER_TASK_CHAPTER_BOX_SUBMIT_RET = 1141 // 领取主线宝箱
	...
	S2C_USER_FIRM_PROP_AUTO_STUDY_START_RET  = 1205 // 开始自动学习
	S2C_USER_FIRM_PROP_AUTO_STUDY_FINISH_RET = 1206 // 结束自动学习
	S2C_USER_FIRM_PROP_AUTO_STUDY_SUBMIT_RET = 1207 // 一键领取经验
	...
	S2C_USER_CARD_TALENT_UNLOCK_RET          = 1510 // 解锁天赋树
	S2C_USER_CARD_SKILL_LEARN_RET            = 1511 // 领悟卡牌技能
	S2C_USER_CARD_SKILL_SAVE_RET             = 1512 // 保存卡牌技能
	...
	S2C_USER_HOME_DIAMOND_BUY_RET                = 1723 // 购买小屋钻石
	S2C_USER_HOME_SPEEDUP_ITEM_BUY_RET           = 1724 // 购买小屋加速卡
	S2C_USER_BILLBOARD_DATE_TICKET_BUY_RET       = 1725 // 购买看板一日约会门票
	S2C_USER_BILLBOARD_TIME_LIMIT_TICKET_BUY_RET = 1726 // 购买看板限时一日约会门票
	...
	S2C_USER_RANK_POWER_LIST_RET = 1941 // 获取战力排行榜
	...
	S2C_USER_FH_QUEST_COUNTING_RET = 2100 // bingo 前端任务发送， 后端过滤校验
	/* 充值类活动 */
	...
	S2C_USER_SPACE_DESC_UPDATE_RET       = 2781 // 更新空间签名
	S2C_USER_SPACE_SHOW_CARD_UPDATE_RET  = 2782 // 更新空间展示卡牌
	S2C_USER_SPACE_QUERY_RET             = 2783 // 获取空间信息
	...
	S2C_USER_FH_GET_INFO_RET                  = 2850 // 小屋详细信息
	S2C_USER_FH_UNLOCK_AREA_RET               = 2851 // 小屋解锁区域
	S2C_USER_FH_SET_POS_RET                   = 2852 // 小屋保存女主坐标
	S2C_USER_FH_DECORATE_RET                  = 2853 // 小屋装饰
	S2C_USER_FH_AREA_STORY_REWARD_SUBMIT_RET  = 2854 // 小屋解锁区域奖励领取
	S2C_USER_FH_UNLOCK_UNIT_RET               = 2855 // 小屋单元解锁
	S2C_USER_FH_UNIT_PATTERN_RECOVER_RET      = 2856 // 小屋家具回收
	S2C_USER_FH_BRIEF_INFO_RET                = 2857 // 小屋简要信息
	S2C_USER_FH_GIFT_REWARD_SUBMIT_RET        = 2858 // 小屋收菜
	S2C_USER_FH_ACHV_SUBMIT_RET               = 2859 // 小屋成就（主线）提交
	S2C_USER_FH_DAILY_QUEST_SUBMIT_RET        = 2860 // 小屋每日任务提交
	S2C_USER_FH_GIVE_PRESENT_RET              = 2861 // 小屋送礼
	S2C_USER_FH_UNIT_EXPLORE_SUBMIT_RET       = 2862 // 小屋家具交互
	S2C_USER_FH_DAILY_QUEST_BONUS_SUBMIT_RET  = 2863 // 小屋额外奖励领取
	S2C_USER_FH_MALE_INTERA_SUBMIT_RET        = 2864 // 小屋双人交互
	S2C_USER_FH_RELATE_REWARD_SUBMIT_RET      = 2865 // 小屋亲密度奖励领取
	S2C_USER_HOME_RAND_REWARD_UNIT_SUBMIT_RET = 2866 //小屋收菜奖励

	S2C_USER_HOME_DISPATCH_INFO_REQ_RET      = 2870 // 请求小屋派遣信息的返回信息
	S2C_USER_HOME_DISPATCH_START_REQ_RET     = 2871 // 开始派遣回包
	S2C_USER_HOME_DISPATCH_SPEEDUP_REQ_RET   = 2872 // 加速派遣回包
	S2C_USER_HOME_DISPATCH_GETREWARD_REQ_RET = 2873 // 领奖励回包
	S2C_USER_HOME_DISPATCH_CANCEL_REQ_RET    = 2874 // 执行撤销操作回包
	S2C_USER_HOME_DISPATCH_REFRESH_REQ_RET   = 2875 // 刷新请求回包
	S2C_USER_HOME_DISPATCH_CURRENT_BRIEF_RET = 2876 // 获取当前派遣队列状态（红点）

	S2C_USER_HOME_BUBBLE_GET_RET    = 2880 // 获取短事件协议
	S2C_USER_HOME_BUBBLE_FINISH_RET = 2881 // 完成短事件协议

	S2C_USER_HOME_GUIDE_BONUS_SUBMIT_RET = 2890 // 领取小屋新手引导奖励

	S2C_USER_BILLBOARD_MALE_SELECT_RET                 = 2901 // 看板系统 选择看板内出现的男主
	S2C_USER_BILLBOARD_MALE_STATE_SUBMIT_RET           = 2902 // 看板系统 男主状态变更 进入看板系统的时候也要发过来
	S2C_USER_BILLBOARD_MALE_RESPONSE_REWARD_SUBMIT_RET = 2903 // 看板系统 男主反馈领取奖励
	S2C_USER_BILLBOARD_PURCHASE_ITEM_RET               = 2904 // 看板系统 在面板购买已解锁物品
	S2C_USER_BILLBOARD_DRESSUP_SUBMIT_RET              = 2905 // 看板系统 男主换装提交
	S2C_USER_BILLBOARD_DATE_LIST_REQ_RET               = 2906 // 看板系统 获取一日约会入口
	S2C_USER_BILLBOARD_DATE_ENTER_RET                  = 2907 // 看板系统 进入一日约会
	S2C_USER_BILLBOARD_DATE_MOVE_RET                   = 2908 // 看板系统 一日约会进行选择
	S2C_USER_BILLBOARD_DATE_FINISH_RET                 = 2909 // 看板系统 一日约会结束领奖
	S2C_USER_ENTER_BILLBOARD_RET                       = 2910 // 进入看板系统
	S2C_USER_BILLBOARD_MUSIC_SUBMIT_RET                = 2911 // 看板系统 更换BGM
	S2C_USER_BILLBOARD_LOGIN_FAVOR_RET                 = 2912 // 看板系统 登录增加好感度

	S2C_USER_MATERIAL_TASK_DO_RET            = 3001 // 开始天赋树材料副本
	S2C_USER_MATERIAL_TASK_LEAVE_RET         = 3002 // 离开天赋树材料副本
	S2C_USER_MATERIAL_TASK_SWEEP_RET         = 3003 // 扫荡天赋树材料副本
	S2C_USER_MATERIAL_TASK_BUY_CNT_RET       = 3004 // 购买天赋树材料副本次数
	S2C_USER_MATERIAL_TASK_REWARD_SUBMIT_RET = 3005 // 领取天赋树材料副本奖励

	S2C_USER_PUBLISH_ZONE_MSG_SUBMIT_RET = 3011 // 发布大区广播消息
	S2C_USER_GET_ZONE_MSG_SUBMIT_RET     = 3012 // 获取大区广播消息
	...
	S2C_USER_SYSTEM_ACTIVE_TIME_RET                  = 4031 // 系统活跃时间通知
	S2C_USER_ACTIVITY_LIVENESS_ADDUP_SUBMIT_RET      = 4032 // 领取累计活跃度奖励
	S2C_USER_ACTIVITY_MAIN_QUEST_GET_AWARD_RET       = 4033 // 主线卡每日宝箱

	S2C_USER_ACTIVITY_NEW_BIRTHDAY_MAKE_PRESENT_RET = 4041 // 新生日礼物制作
	S2C_USER_ACTIVITY_NEW_BIRTHDAY_SEND_PRESENT_RET = 4042 // 新生日送礼
	S2C_USER_ACTIVITY_PUBLISH_REWARD_SUBMIT_RET     = 4043 // 发布奖励领取
	S2C_USER_ACTIVITY_NEW_BIRTHDAY_FILE_SELECT_RET  = 4044 // 新生日选择档案选项
	S2C_USER_ACTIVITY_NEW_BIRTHDAY_STORY_READ_RET   = 4045 // 新生日进入剧情

	S2C_EXCHANGE_GOODS_RET         = 4051 // 兑换请求
	S2C_EXCHANGE_STORE_REFRESH_RET = 4052 // 兑换商店刷新请求

	S2C_SPRING_FESTIVAL_PIECE_GAIN_RET         = 4061 // 春节翻牌子
	S2C_SPRING_FESTIVAL_PIECE_SHARE_RET        = 4062 // 春节翻牌子 分享
	S2C_SPRING_FESTIVAL_PIECE_SHARE_REWARD_RET = 4063 // 春节翻牌子 领取分享奖励
	S2C_SPRING_FESTIVAL_PIECE_OPEN_REWARD_RET  = 4064 // 春节翻牌子 打开礼物

	S2C_DOUBLE_ACTIVITY_REWARD_RET            = 4071 // 一元限购领奖响应
	S2C_DOUBLE_ACTIVITY_CUMULATION_REWARD_RET = 4072 // 一元限购累积奖励响应

	S2C_USER_ACTIVITY_HOME_LOTTERY_SUBMIT_RET = 4080 // 家具阁抽奖

	S2C_USER_YSDK_GET_BALANCE_SUBMIT_RET = 4090 // 拉取米大师余额响应

	S2C_USER_ACTIVITY_SNOW_TASK_MERGE_SUBMIT_RET        = 4100 // 新主线预热 合成
	S2C_USER_ACTIVITY_SNOW_TASK_SHARE_SUBMIT_RET        = 4101 // 新主线预热 分享
	S2C_USER_ACTIVITY_SNOW_TASK_WATCH_PV_SUBMIT_RET     = 4102 //新主线预热 观看视频
	S2C_USER_ACTIVITY_SNOW_TASK_SHARE_REWARD_SUBMIT_RET = 4103 //新主线预热 领取分享奖励
	...
	S2C_USER_HOME_STORY_BOOK_CHANGE                         = 5250 // 图鉴变化 （包含短事件 主线事件）
	S2C_USER_HOME_INTERACTION_CHANGE                        = 5251 // 交互动作变化
	S2C_USER_HOME_NPC_INTERACTION_CHANGE                    = 5252 // 交互动作变化
	S2C_USER_FH_ACHV_CHANGE                                 = 5253 // 小屋成就变化
	S2C_USER_ACTIVITY_BINGO_QUEST_CHANGE                    = 5254 // bingo任务计数变化 (现只针对小屋部分，其余走之前机制)
	S2C_USER_FH_UNIT_EXPLORE_EVENT_CHANGE                   = 5255 // 小屋家具交互事件更新通知
	S2C_USER_FH_PRESENT_GALARY_CHANGE                       = 5256 // 小屋礼物图鉴更新通知
	S2C_USER_FH_DAILY_QUEST_CHANGE                          = 5257 // 小屋日常任务通知
	S2C_USER_FH_MALE_EMOT_CHANGE                            = 5258 // 小屋男主心情变化
	S2C_USER_FH_RELATE_CHANGE                               = 5259 // 小屋货币变化
	S2C_USER_FH_UNIT_PATTERN_CHANGE                         = 5260 // 小屋家具变化
	S2C_USER_HOME_BUBBLE_CHANGE                             = 5261 // 气泡事件变化（包含短事件 主线事件）
	S2C_USER_PUSH_PACK_ACTIVITIES_INFO_NOTIFY               = 5262 // 礼包推送
	S2C_USER_HOME_RAND_REWARD_UNIT_NOTIFY                   = 5263 // 小屋家具随机奖励通知
	S2C_USER_HEART_KEY_CHANGE                               = 5264 // 心之匙（材料副本次数道具）变化
	S2C_USER_BB_DATE_TICKET_CHANGE                          = 5265 // 看板约会门票变化
	S2C_USER_BILLBOARD_ITEM_CHANGE                          = 5266 // 看板物品变化
	S2C_USER_ACHIEVEMENT_CHANGE                             = 5267 // 成就变化
	S2C_USER_DAILY_QUEST_CHANGE                             = 5268 // 每日变化
	S2C_USER_ZONE_PUBLISH_MSG_NTF                           = 5269 //	gamesvr广播消息通知
	S2C_USER_ACTIVITY_DOUBLE_ACTIVITY_NOTIFY                = 5270 // 一元翻倍随机及重置信息每日通知
	S2C_USER_ACTIVITY_DOUBLE_ACTIVITY_RETURN_PRESENT_NOTIFY = 5271 // 一元翻倍 回礼通知
	S2C_USER_CLIENT_HOTFIX_NOTIFY                           = 5272 // 客户端热更新通知

	S2C_SVR_VERSION_CHANGE = 5301 // 服务器版本变化

	S2C_USER_ACTIVITY_H5_WEBVIEW = 6001 // H5页面参数加密结果
)
...
const (
	...
	S2S_SYS_CLIENT_HOTFIX_NOTIFY       = 1223 // 前端热更新通知
)
